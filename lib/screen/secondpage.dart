    ...
    return Consumer<AppProvider>(
      builder: (context, provider, child) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            title: Center(child: Text("AUTOMATIC SWITCH", style: provider.font1)),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    // slider untuk adjust threshold sensor LDR
                    //harusnya ldr itu thresholdnya 0-1040 tp di set jadi 1-100% aja
          ...
          bottomNavigationBar: BottomAppBar(
            ...
            child: Row(
              ...
              children: [
                IconButton(
                  onPressed: () {
                    //matiin auto mode sebelum balik ke homepage
